...
function FriendsPanel({ onBack, onOpenChat }: FriendsPanelProps): React.ReactElement {
  ...
  const handleAddFriend = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    if (!trimmed) {
      setAddError('Please enter a User ID or email.');
      return;
    }
          ...
          <div className="friends-list-section">
            {loading ? (
              ...
              <div className="friends-empty">
                ...
                <p>No friends yet</p>
                <p className="friends-empty-hint">Add friends by their User ID or email!</p>
              </div>
            ) : (
        ...
        {tab === 'add' && (
          <div className="friends-add-section">
            <div className="add-friend-info">
              <p>Add a friend by entering their User ID or email address.</p>
