...
describe('ResultScreen', () => {
  ...
  describe('markers', () => {
    ...
    it('should position guess marker correctly', () => {
      ...
      const guessMarker = container.querySelector('.guess-marker') as HTMLElement;
  ...
  describe('floor scoring', () => {
    ...
    it('should show wrong floor message when floor differs', () => {
      render(<ResultScreen {...defaultProps} guessFloor={1} actualFloor={2} floorCorrect={false} />);
    ...
    it('should apply penalty styling for wrong floor', () => {
      const { container } = render(
        <ResultScreen {...defaultProps} guessFloor={1} actualFloor={2} floorCorrect={false} />
      );
