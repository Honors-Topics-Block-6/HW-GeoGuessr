...
import type { Region, PlayingArea, DrawModeType } from './PolygonDrawer';
...
describe('RegionPanel', () => {
  ...
  const defaultProps = {
    ...
    isDrawing: false,
    drawMode: 'none' as DrawModeType,
    newPolygonPoints: [] as { x: number; y: number }[],
    playingArea: null as PlayingArea | null,
  ...
  describe('floor formatting', () => {
    it('should show "None" for empty floors array', () => {
      const regionsWithNoFloors: Region[] = [{
        id: 'region-1',
        name: 'Test',
  ...
  describe('effect dependencies', () => {
    ...
    it('should handle region with missing name property', () => {
      ...
      render(<RegionPanel {...defaultProps} regions={regionsWithMissingName as Region[]} selectedRegionId="region-1" />);
    ...
    it('should handle region with missing floors property', () => {
      ...
      render(<RegionPanel {...defaultProps} regions={regionsWithMissingFloors as Region[]} selectedRegionId="region-1" />);
    ...
    it('should handle region with missing color property', () => {
      ...
      render(<RegionPanel {...defaultProps} regions={regionsWithMissingColor as Region[]} selectedRegionId="region-1" />);
  ...
  describe('handleFloorToggle edge cases', () => {
    it('should add floor and maintain sort order', async () => {
      ...
      const regionsWithFloor2: Region[] = [{
        id: 'region-1',
        name: 'Test',
        polygon: [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 1, y: 1 }],
        floors: [2],
  ...
  describe('region list item rendering', () => {
    it('should display region color in swatch correctly', () => {
      const customColorRegions: Region[] = [{
        id: 'region-1',
        name: 'Red Region',
        polygon: [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 1, y: 1 }],
        floors: [1],
      ...
      const swatch = document.querySelector('.region-color-swatch') as HTMLElement;
    ...
    it('should use default color when region has no color', () => {
      ...
      render(<RegionPanel {...defaultProps} regions={noColorRegions as Region[]} />);
