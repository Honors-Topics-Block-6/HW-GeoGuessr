...
vi.mock('../MapPicker/MapPicker', () => ({
  default: ({ markerPosition, onMapClick }: { markerPosition: { x: number; y: number } | null; onMapClick: (pos: { x: number; y: number }) => void }) => (
...
vi.mock('../FloorSelector/FloorSelector', () => ({
  default: ({ selectedFloor, onFloorSelect }: { selectedFloor: number | null; onFloorSelect: (floor: number) => void }) => (
...
describe('AdminReview', () => {
  ...
  describe('error handling', () => {
    it('should handle Firestore error gracefully', () => {
      mockOnSnapshot.mockImplementation((query: unknown, successCallback: unknown, errorCallback: (err: Error) => void) => {
  ...
  describe('edit mode', () => {
    ...
    const openModalForPendingSubmission = async (user: ReturnType<typeof userEvent.setup>) => {
  ...
  describe('delete photo functionality', () => {
    ...
    describe('delete confirmation popup', () => {
      ...
      it('should show photo thumbnail in confirmation popup', async () => {
        ...
        const confirmImage = document.querySelector('.delete-confirm-image') as HTMLImageElement;
