...
describe('imageService', () => {
  ...
  describe('getAllApprovedImages', () => {
    it('should fetch from both images and submissions collections', async () => {
      ...
      mockedGetDocs
        ...
        .mockResolvedValueOnce({ docs: mockSubmissionsDocs } as never);
    ...
    it('should return empty array on error', async () => {
      mockedGetDocs.mockRejectedValueOnce(new Error('Firestore unavailable'));
  ...
  describe('getRandomImage', () => {
    ...
    it('should return random image when multiple available', async () => {
      ...
      mockedGetDocs
        .mockResolvedValue({ docs: mockImagesDocs } as never);
